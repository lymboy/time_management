	...
	<view class="zai-box">
        <scroll-view scroll-y class="page">
            <view class="text-center" :style="[{animation: 'show ' + 0.4+ 's 1'}]">
				<image src="http://lc.lymboy.com:8090/jeecg-boot/sys/common/static/lb_logo_1679644778383.png" mode='aspectFit' class="zai-logo "></image>
				<view class="zai-title text-shadow ">龙佰集团</view>
                <view class="text-df">员工出勤工时管理平台</view>
			</view>
